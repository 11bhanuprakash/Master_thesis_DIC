...
sec_top_left_x = x_all[1, 1, :]
sec_top_left_y = y_all[1, 1, :]

sec_top_right_x = x_all[-2, 1, :]
sec_top_right_y = y_all[-2, 1, :]

sec_bottom_left_x = x_all[1, -2, :]
sec_bottom_left_y = y_all[1, -2, :]

sec_bottom_right_x = x_all[-2, -2, :]
sec_bottom_right_y = y_all[-2, -2, :]

#third corner-------------------------------------------------------
third_top_left_x = x_all[2, 2, :]
third_top_left_y = y_all[2, 2, :]

third_top_right_x = x_all[-3, 2, :]
third_top_right_y = y_all[-3, 2, :]

third_bottom_left_x = x_all[2, -3, :]
third_bottom_left_y = y_all[2, -3, :]

third_bottom_right_x = x_all[-3, -3, :]
third_bottom_right_y = y_all[-3, -3, :]
...
plt.plot(sec_top_left_x, sec_top_left_y, 'o-', label='Second Top-Left')
plt.plot(sec_top_right_x, sec_top_right_y, 'o-', label='Second Top-Right')
plt.plot(sec_bottom_left_x, sec_bottom_left_y, 'o-', label='Second Bottom-Left')
plt.plot(sec_bottom_right_x, sec_bottom_right_y, 'o-', label='Second Bottom-Right')
plt.plot(third_top_left_x, third_top_left_y, 'o-', label='Third Top-Left')
plt.plot(third_top_right_x, third_top_right_y, 'o-', label='Third Top-Right')
plt.plot(third_bottom_left_x, third_bottom_left_y, 'o-', label='Third Bottom-Left')
plt.plot(third_bottom_right_x, third_bottom_right_y, 'o-', label='Third Bottom-Right')
...
D11 = np.sqrt((sec_top_left_x - sec_bottom_right_x)**2 + (sec_top_left_y - sec_bottom_right_y)**2)
D21 = np.sqrt((sec_top_right_x - sec_bottom_left_x)**2 + (sec_top_right_y - sec_bottom_left_y)**2)

D12 = np.sqrt((third_top_left_x - third_bottom_right_x)**2 + (third_top_left_y - third_bottom_right_y)**2)
D22 = np.sqrt((third_top_right_x - third_bottom_left_x)**2 + (third_top_right_y - third_bottom_left_y)**2)
...
ax.plot(D11_mm, label='D11: Second Top-Left ↔ Second Bottom-Right', marker='^')
ax.plot(D21_mm, label='D21: Second Top-Right ↔ Second Bottom-Left', marker='v')
ax.plot(D12_mm, label='D12: Third Top-Left ↔ Third Bottom-Right', marker='d')
ax.plot(D22_mm, label='D22: Third Top-Right ↔ Third Bottom-Left', marker='p')
